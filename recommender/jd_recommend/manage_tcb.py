...
def handle_tcb_lt_photo_threshold(
...
def handle_tcb_geq_photo_threshold(
    patient: Patient, blood_threshold: float
) -> str or list[str]:
...
def recommend_from_tcb(
    patient: Patient, photo_threshold: float, blood_threshold: float
) -> str or list[str]:
    """
